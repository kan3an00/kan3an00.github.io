    ...
    <div v-if="mount">
        ...
        <main class="lg:mx-32 mx-4 mt-32">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-14 py-10">
                <div v-for="(country, index) in countries" :key="index" class="rounded-md dark:bg-header-dark bg-white shadow-lg overflow-hidden cursor-pointer pb-6" @click="openCountryDetails(country.name)">
    ...
    export default {
        ...
        methods:{
            openCountryDetails(country){
                this.$router.push(`/details?country=${country}`)
            },
            search(){
